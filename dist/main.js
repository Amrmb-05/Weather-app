...
async function parseDailyWeather(data, day) {
  ...
  for (let i = 1; i <= day; i += 1) {
    const dailyWeatherData = {
      day: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(response.forecast.forecastday[i].date), "EEEE"),
